        ...
        <div class="quiz">
          ...
          <div class="blackboard">
            ...
            <div class="blackboard_stage">
              <button id="WQ_stage1" class="WQ_stage" value="지"  onclick="location.href='KingWordGame.html'">
              ...
              <button id="WQ_stage1" class="WQ_stage" value="지" onclick="KingWordGame2_click(this.value)">
                <div class="WQ_stageno">
                  2
                </div>
                <div class="WQ_stagestar">
