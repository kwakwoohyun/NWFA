  ...
  <article class="page_main">
    <div class="account_main">
      ...
      <div class="account_form">
        ...
        <input class="account_form_input" type="text" name="이메일" value="" placeholder="이메일을 입력하세요">
      </div>
      <div class="account_form">
        <label for="이메일">비밀번호</label>
        <input class="account_form_input" type="password" name="비밀번호" value="" placeholder="비밀번호를 입력하세요">
      </div>
      <div class="account_form">
        <label for="이메일">비밀번호 확인</label>
        <input class="account_form_input" type="password" name="비밀번호확인" value="" placeholder="비밀번호를 한번더 입력하세요">
      </div>
      <div class="account_form">
        <label for="이메일">이름</label>
        <input class="account_form_input" type="text" name="이름" value="" placeholder="이름을 입력하세요">
      </div>
      <div class="account_form">
        <label for="이메일">나이 </label>
        <input class="account_form_input" type="text" name="나이" value="" placeholder="나이를 입력하세요">
      </div>
      <div class="account_form">
        ...
        <div class="account_form_sex">
          ...
          여자
          <input type="radio" name="성별" value="2">
        </div>
      </div>
      <div class="make_id">
        회원가입
