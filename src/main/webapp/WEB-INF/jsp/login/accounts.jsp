...
<body id="page_account" class="page_main page_normal" class="background">
	<div id="layer_background">
		<div class="background_account"></div>
	</div>
	<div id="layer_control">
		<header class="page_main">
			...
			<div class="C_headerbar">
				<div class="personal_titleBar">| 회원가입</div>
			</div>
						...
						<form method="post" action="userRegister" id="userRegister">
							...
							<div class="account_form">
								<label for="이메일">비밀번호</label> <input class="account_form_input"
									type="password" name="userPassword1" id="userPassword1"
									value="" placeholder="비밀번호를 입력하세요" maxLength="20">
							</div>
							<div class="account_form">
								<label for="이메일">비밀번호 확인</label> <input
									class="account_form_input" type="password" name="userPassword2"
									id="userPassword2" value="" placeholder="비밀번호를 한번더 입력하세요"
									maxLength="20">
							</div>
							<div class="account_form">
								<label for="이메일">이름</label> <input class="account_form_input"
									type="text" name="userName" id="userName" value=""
									placeholder="이름을 입력하세요" maxLength="20">
							</div>
							<div class="account_form">
								<label for="이메일">나이 </label> <input class="account_form_input"
									type="text" name="userAge" id="userAge" value=""
									placeholder="나이를 입력하세요">
							</div>
							<div class="account_form">
								<label for="이메일">성별</label>
								<div class="account_form_sex">
									남자 <input type="radio" name="userGender" value="남자"> 여자
							...
							<div class="make_id">
								<a href="#"
									onclick="document.getElementById('userRegister').submit();">
									회원가입 </a>
							</div>
	...
	<div id="layer_modal">
		...
		<div class="popup_account_Error">
			<div class="popup_account_Error_window"></div>
		</div>
		<!--[정인국] 비밀번호가 존재하지 않는 경우  -->
		<div class="popup_Fail_PW">
			<div class="popup_Fail_PW_window">비밀번호가 일치하지 않습니다.</div>
		</div>
	</div>
</body>
</html>