...
<body id="tmep" class="page_main page_normal" class="background">
  ...
  <article class="page_main flex">
    <div class="">
      <h1>프론트/로비</h1>
      <a class="Sort_BT_game Sort_BT" href="/">★프론트</a>
      <a class="Sort_BT_game Sort_BT" href="#">게임로비</a>
      ...
      <a class="Sort_BT_game Sort_BT" href="personal">★업적</a>
      <a class="Sort_BT_game Sort_BT" href="#">설정</a>
    </div>
    <div class="">
      <h1>게임1</h1>
