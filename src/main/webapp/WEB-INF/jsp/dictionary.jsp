...
<body id="page_personal" class="page_main page_normal" class="background">
  ...
  <article class="page_main">
    <div class="Sort_BT_Bar">
      <div class="Sort_BT_all Sort_BT">
        전체
      </div>
      <div class="Sort_BT_NewWord Sort_BT">
        신조어업적
      </div>
      <div class="Sort_BT_game Sort_BT">
        게임업적
      </div>
      <div class="Sort_BT_ect Sort_BT">
        기타업적
      </div>
    </div>
    <div class="goal_contents">
      <div class="personal_sidemenu">
        <div class="rank personal_sidemenu_BT">
          랭킹
        </div>
        <div class="point personal_sidemenu_BT">
          점수
        </div>
        <div class="goal personal_sidemenu_BT">
          도전과제
        </div>
        <div class="set personal_sidemenu_BT">
          설정
        </div>
      </div>
      <div class="goal_main_contents">
      </div>
