	...
	<div id="layer_control">
		<header class="page_main">
			...
			<div class="C_headerbar">
				<div class="mainlobbyTitle">게임을 선택해주세요</div>
			</div>
			...
			<div class="gameRail">
				<div id="game_Sejong" class="game" onclick="click_Sejong();">
					<div id="game_Sejong_TEXT">
						<span>세종대왕</span><br> <span>단어게임</span>
					</div>
					<div id="game_Sejong_IMG"></div>
				</div>
				<div id="game_WordQuiz" class="game" onclick="click_WordQuiz();">
					<div id="game_WordQuiz_TEXT">
						<span>도전!</span><br> <span>신조어</span>
					</div>
					<div id="game_WordQuiz_IMG"></div>
				</div>
				<div id="game_Talk" class="game" onclick="click_Talk();">
					<div id="game_Talk_TEXT"></div>
					<div id="game_Talk_IMG"></div>
				</div>
			</div>
		</div>
		<div class="gameSelector">
			<div class="gameNumber">
				<div class="game1" onclick="click_Sejong();"></div>
				<div class="game2" onclick="click_WordQuiz();"></div>
				<div class="game3" onclick="click_Talk();"></div>
			</div>
			<div class="gameInfo">
				<div></div>
				<div class="gameStart">
					<button id="gameStartBotton" type="button" name="gameStart"
						onclick="click_GameStart();">시작하기</button>
				...
				<div class="gameRanking">
					...
					<div class="GameNamePlace">
						<div class="GameName">최고 도달 스테이지</div>
						<div class="GameRank">Lv.${islock1 }</div>
					</div>
				</div>
			</div>
