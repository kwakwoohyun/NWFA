			...
			<div class="popup_GameScore">
				...
				<div class="popup_GameScore_Score_window">
					...
					<div class="popup_GameScore_btn_box">
						<c:choose>
							<c:when test="${words[0].stage_id eq 3}">
							...
							<c:otherwise>
								<c:if test="${score ge 60}">
									...
									<div class="popup_GameScore_NextGame" id="NextGame"
										onclick="location.href='/setScoreYamin/${words[0].stage_id}/${score }'">다음
										스테이지 학습하기</div>
								</c:if>
								<c:if test="${score lt 60}">
									<div class="popup_GameScore_Score_Text">60점을 향해 노력하세요!</div>
									<div class="popup_GameScore_NextGame" id="NextGame"
										onclick="location.href='/reGameYamin/${words[0].stage_id}/${score }'">다시
										학습하기</div>
								</c:if>
							</c:otherwise>
						</c:choose>
