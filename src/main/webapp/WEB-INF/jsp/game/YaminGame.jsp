        ...
        <button id="WQ_BT8" class="WQ_BT" value="머" onclick="KingWordGame1_click(this.value)">
          머
			...
			<footer class="page_main KingWordGamefooter">
				...
				<div class="KW_regame CQ_BTstyle">다시하기</div>
	...
	<div id="layer_modal">
		<div class="popup_GameEnd">
			<div class="popup_GameClear">
				...
				<div class="popup_GameClear_NextGame" id="NextGame">다음 스테이지</div>
				<div class="popup_GameClear_Lobby" id="MoveLobby">로비로 나가기</div>
			</div>
			<div class="popup_GameOver">
				<div class="popup_GameOver_Text">GAME OVErr</div>
				<div class="popup_GameOver_Regame" id="ReGame">게임 다시하기</div>
				<div class="popup_GameOver_Lobby" id="MoveLobby">로비로 나가기</div>
			</div>
		</div>
	</div>
</body>
